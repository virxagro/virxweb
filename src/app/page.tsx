...
export default function Home() {
  ...
  return (
    <div className="bg-[#0A0A0A] text-white selection:bg-virx-cyan selection:text-white">
      ...
      <section 
        ref={heroRef} 
        className="relative min-h-screen flex items-center justify-center pt-32 pb-12 overflow-hidden bg-cover bg-[position:75%_center] lg:bg-center bg-no-repeat"
